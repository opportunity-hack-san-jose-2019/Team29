...
getMatchesMR = (req, res, conn) => {
    ...
    let output = "";
    Mentor.find({ mentor_email: req.body.mentor_email} , {connect:{$elemMatch:{ connectStatus:{$in: ["Accept"] }}}}, {mentor_firstName:1, mentor_lastName:1, connect: 1 }, function (error, results) {
        if (error) {
